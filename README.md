    ...
    if v.Name == "UnitGridPrefab" then
        ...
        if v.LayoutOrder == -7 then
            if v:FindFirstChild("Button") and v.Button:FindFirstChild("UnitNameLabel") then
                ...
                print("Button or UnitNameLabel not found in UnitGridPrefab with LayoutOrder -7")
            end
        elseif v.LayoutOrder == -6 then
            if v:FindFirstChild("Button") and v.Button:FindFirstChild("UnitNameLabel") then
                ...
                print("Button or UnitNameLabel not found in UnitGridPrefab with LayoutOrder -6")
            end
        elseif v.LayoutOrder == -5 then
            if v:FindFirstChild("Button") and v.Button:FindFirstChild("UnitNameLabel") then
                ...
                print("Button or UnitNameLabel not found in UnitGridPrefab with LayoutOrder -5")
            end
        end
    end
end
